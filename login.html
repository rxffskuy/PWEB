...
<body>
    <div class="container mx-auto">
        <form action="dashboard.html" method="post" class="form-control">
            <section class="bg-white dark:border-gray-900">
                <div class="flex flex-col items-center justify-center px-6 pb-8 pt-16 mx-auto h-screen md:h-screen lg:py-0">
